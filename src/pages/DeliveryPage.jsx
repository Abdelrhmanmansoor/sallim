        ...
        <div dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
            ...
            <section style={{ background: '#fff', padding: '80px 24px 120px' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto', fontSize: '15px', color: '#475569', lineHeight: 2.2 }}>
                    ...
                    <h2 style={{ fontSize: '22px', fontWeight: 700, color: '#0f172a', marginBottom: '16px', marginTop: '40px' }}>الخطط والاشتراكات</h2>
                    <p>للاشتراكات في نظام الشركات:</p>
                    <ul style={{ paddingRight: '24px', margin: '12px 0' }}>
                        <li>تفعيل الحساب يتم فورًا بعد التسجيل</li>
                        <li>ستتلقى بريد إلكتروني بتأكيد التسجيل</li>
                        <li>يمكنك الاستفادة من جميع الميزات فور إنشاء الحساب</li>
                        <li>في حالة وجود أي مشكلة، يُرجى التواصل معنا</li>
                    </ul>
