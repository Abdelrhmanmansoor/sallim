...
export default function SendPage() {
  ...
  const [message, setMessage] = useState('⁄Ìœ „»«—ﬂ Êﬂ· ⁄«„ Ê√‰ „ »ŒÌ—')
  ...
  const [linkGreeting, setLinkGreeting] = useState('ﬂ· ⁄«„ Ê√‰ „ »ŒÌ—')
  ...
  const [eidiyaCurrency, setEidiyaCurrency] = useState('—Ì«·')
  ...
  const handleCSVUpload = (e) => {
    ...
    reader.onload = (ev) => {
      try {
        ...
        toast.success(` „  Õ„Ì· ${data.length} ÃÂ… « ’«·!`)
      } catch (err) {
        toast.error('Œÿ√ ›Ì ﬁ—«¡… «·„·›.  √ﬂœ „‰ «· ‰”Ìﬁ «·’ÕÌÕ.')
      }
    }
  ...
  const handleBulkSend = async () => {
    ...
    for (let i = 0; i < csvData.length; i++) {
      const row = csvData[i]
      const personalMessage = message.replace('{name}', row['«·«”„'] || row['name'] || '')
      const phoneNum = row['«·—ﬁ„'] || row['phone'] || row['—ﬁ„'] || ''
    ...
    setIsSending(false)
    toast.success(` „ ≈—”«· ${csvData.length} —”«·… »‰Ã«Õ!`)
  }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-[#6A47ED]/10 border border-[#6A47ED]/20 rounded-full px-5 py-2 mb-5">
            ...
            <span className="text-[#A78BFA] text-xs font-medium">ÿ—ﬁ ≈—”«· „ ⁄œœ…</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-black mb-4">
            <span className="gradient-gold-text">√—”· »ÿ«ﬁ ﬂ</span>
            <span className="text-[#0F172A]"> »√‰«ﬁ…</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-xl mx-auto">√—”· »ÿ«ﬁ«  «·⁄Ìœ ·√Õ»«»ﬂ ⁄»— Ê« ”«»°  ·ÌÃ—«„° »—Ìœ ≈·ﬂ —Ê‰Ì° √Ê Õ„¯·Â« »ÃÊœ… ⁄«·Ì…</p>
        ...
        {/* Mode Selector ó Premium Tabs */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-12">
          {[
            { id: 'eidiya', icon: <BsGift />, label: '⁄ÌœÌ… »ÕŸﬂ', desc: '⁄œ«œ ⁄‘Ê«∆Ì' },
            { id: 'link', icon: <BsLink45Deg />, label: '»ÿ«ﬁ… —«»ÿ', desc: '—«»ÿ „Œ’’' },
            { id: 'single', icon: <BsPersonPlus />, label: '≈—”«· ›—œÌ', desc: '‘Œ’ Ê«Õœ' },
            { id: 'bulk', icon: <BsPeople />, label: '≈—”«· Ã„«⁄Ì', desc: 'ﬁ«∆„… CSV' },
            { id: 'share', icon: <HiShare />, label: '„‘«—ﬂ… ”—Ì⁄…', desc: 'ﬂ· «·„‰’« ' },
            { id: 'zip', icon: <BsFileZip />, label: ' Õ„Ì· ZIP', desc: '»ÿ«ﬁ«  „Œ’’…' },
          ].map((mode) => (
            <button
              key={mode.id}
        ...
        {sendMode === 'eidiya' && (
          <div className="glass rounded-3xl p-8 md:p-12 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                <h3 className="text-xl font-black text-white">⁄ÌœÌ ﬂ »ÕŸﬂ!</h3>
                <p className="text-gray-400 text-sm">√‰‘∆ —«»ÿ ⁄ÌœÌ… ó «·„” ·„ Ì·› «·⁄œ«œ ÊÌ‘Ê› ÕŸÂ</p>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <label className="text-sm text-[#8B6CF6] font-bold">«”„ﬂ («·„ı⁄ÛÌˆ¯œ)</label>
                </div>
                <input
                  type="text"
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <label className="text-sm text-[#8B6CF6] font-bold">«··ÂÃ… Ê«·⁄„·…</label>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <option value="sa" className="bg-gray-900">”⁄ÊœÌ</option>
                    <option value="ae" className="bg-gray-900">≈„«—« Ì</option>
                    <option value="kw" className="bg-gray-900">ﬂÊÌ Ì</option>
                    <option value="bh" className="bg-gray-900">»Õ—Ì‰Ì</option>
                    <option value="qa" className="bg-gray-900">ﬁÿ—Ì</option>
                    <option value="om" className="bg-gray-900">⁄ı„«‰Ì</option>
                  </select>
                  <select
                    ...
                    className="bg-white/5 border border-white/10 rounded-xl p-3 text-white text-sm focus:border-[#6A47ED]/50 focus:outline-none appearance-none text-center"
                  >
                    <option value="—Ì«·" className="bg-gray-900">—Ì«·</option>
                    <option value="œ—Â„" className="bg-gray-900">œ—Â„</option>
                    <option value="œÌ‰«—" className="bg-gray-900">œÌ‰«—</option>
                    <option value="œÌ‰«— »Õ—Ì‰Ì" className="bg-gray-900">œÌ‰«— »Õ—Ì‰Ì</option>
                    <option value="—Ì«· ﬁÿ—Ì" className="bg-gray-900">—Ì«· ﬁÿ—Ì</option>
                    <option value="—Ì«· ⁄ı„«‰Ì" className="bg-gray-900">—Ì«· ⁄ı„«‰Ì</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <label className="text-sm text-[#8B6CF6] font-bold">„»·€ «·⁄ÌœÌ…</label>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs text-gray-500 block mb-1 text-center">«·Õœ «·√œ‰Ï</label>
                    <input
                      type="number"
                      value={eidiyaMin}
                  ...
                  <div>
                    <label className="text-xs text-gray-500 block mb-1 text-center">«·Õœ «·√ﬁ’Ï</label>
                    <input
                      type="number"
                      value={eidiyaMax}
                ...
                <p className="text-gray-400 text-xs text-center mt-2">«·⁄œ«œ ÂÌÊﬁ› ⁄‘Ê«∆Ì »Ì‰ {eidiyaMin} Ê {eidiyaMax} {eidiyaCurrency}</p>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <label className="text-sm text-[#8B6CF6] font-bold">⁄œœ «·„Õ«Ê·« </label>
                </div>
                ...
                <p className="text-gray-400 text-xs text-center mt-2">«·„” ·„ Ìﬁœ— Ì·› «·⁄œ«œ {eidiyaAttempts === 1 ? '„—… Ê«Õœ…' : `${eidiyaAttempts} „—« `} »”</p>
              </div>
              ...
              {eidiyaLink && (
                <div className="space-y-4 pt-4 border-t border-white/5 animate-fadeInUp">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      onClick={() => {
                        const text = encodeURIComponent(`⁄ÌœÌ ﬂ „‰ ${eidiyaSenderName}° Ã—¯» ÕŸﬂ\n\n${eidiyaLink}`)
        ...
        {sendMode === 'link' && (
          <div className="glass rounded-3xl p-8 md:p-12 max-w-2xl mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                <h3 className="text-xl font-black text-white">√‰‘∆ »ÿ«ﬁ… —«»ÿ</h3>
                <p className="text-gray-400 text-sm">«Œ — »ÿ«ﬁ…° «ﬂ » «·«”„° Ê‘«—ﬂ «·—«»ÿ ó Ì› ÕÂ« «·„” ·„ „»«‘—…</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <label className="text-sm text-[#8B6CF6] font-bold">«”„ «·„” ·„</label>
                </div>
                <input
                  type="text"
                  value={linkName}
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <label className="text-sm text-[#8B6CF6] font-bold">«Œ — «·»ÿ«ﬁ…</label>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <label className="text-sm text-[#8B6CF6] font-bold">‰’ «· Â‰∆…</label>
                </div>
                <textarea
                  value={linkGreeting}
              ...
              {generatedLink && (
                <div className="space-y-4 pt-4 border-t border-white/5 animate-fadeInUp">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <button
                      onClick={() => {
                        const text = encodeURIComponent(`${linkGreeting} Ì« ${linkName}\n\n${generatedLink}`)
                        window.open(`https://wa.me/?text=${text}`, '_blank')
                      }}
                    ...
                    >
                      ...
                      <span className="text-green-300 text-xs font-bold">Ê« ”«»</span>
                    </button>
                    <button
                      onClick={() => {
                    ...
                    >
                      ...
                      <span className="text-blue-300 text-xs font-bold"> ·ÌÃ—«„</span>
                    </button>
                    <button
                      onClick={() => {
                        const text = encodeURIComponent(`${linkGreeting} Ì« ${linkName}\n\n`)
                    ...
                    >
                      ...
                      <span className="text-gray-300 text-xs font-bold"> ÊÌ —</span>
                    </button>
                  </div>
            ...
            <div className="mt-8 pt-5 border-t border-white/5 text-center">
              <p className="text-gray-400 text-xs">⁄œœ «·»ÿ«ﬁ«  «·„ı‰‘√…: <span className="text-[#8B6CF6] font-bold">5,450+</span></p>
            </div>
          </div>
        )}
        ...
        {sendMode === 'single' && (
          <div className="glass rounded-3xl p-8 md:p-12 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                <h3 className="text-xl font-black text-white">≈—”«· ›—œÌ</h3>
                <p className="text-gray-400 text-sm">√—”· »ÿ«ﬁ… ›«Œ—… ·‘Œ’ Ê«Õœ ⁄»— Ê« ”«»</p>
              </div>
            </div>

            <div className="space-y-6">
              <div>
                <label className="text-sm text-[#8B6CF6] font-medium block mb-2">—ﬁ„ «·Â« › („⁄ —„“ «·œÊ·…)</label>
              ...
              <div>
                <label className="text-sm text-[#8B6CF6] font-medium block mb-2">«”„ «·„” ·„ («Œ Ì«—Ì)</label>
                <input
                  type="text"
                  value={name}
              ...
              <div>
                <label className="text-sm text-[#8B6CF6] font-medium block mb-2">‰’ «·—”«·…</label>
                <textarea
                  value={message}
              ...
              <p className="text-center text-gray-400 text-xs">”Ì „ › Õ Ê« ”«» »—”«·… Ã«Â“… ··≈—”«·</p>
            </div>
          </div>
        )}
        ...
        {sendMode === 'bulk' && (
          <div className="glass rounded-3xl p-8 md:p-12 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                <h3 className="text-xl font-black text-white">≈—”«· Ã„«⁄Ì</h3>
                <p className="text-gray-400 text-sm">«—›⁄ „·› CSV »«·√”„«¡ Ê«·√—ﬁ«„</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-gray-400 text-sm font-semibold">«÷€ÿ ·—›⁄ „·› CSV</p>
                <p className="text-gray-400 text-xs mt-2">«· ‰”Ìﬁ: «·«”„° «·—ﬁ„ (”ÿ— ·ﬂ· ‘Œ’)</p>
              </div>
              ...
              {csvFileName && (
                <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-green-400/70 text-xs">{csvData.length} ÃÂ… « ’«·</p>
                  </div>
                </div>
              )}
              ...
              <div>
                <label className="text-sm text-gray-400 block mb-1">
                  ‰’ «·—”«·… <span className="text-[#8B6CF6]">(«” Œœ„ {'{name}'} ·«”„ «·„” ·„)</span>
                </label>
                <textarea
                  value={message}
                  onChange={(e) => setMessage(e.target.value)}
                  ...
                  rows={4}
                  dir="rtl"
                  placeholder="⁄Ìœ „»«—ﬂ Ì« {name}° ﬂ· ⁄«„ Ê√‰  »ŒÌ—"
                />
              </div>
              ...
              <div>
                <label className="text-sm text-gray-400 flex items-center gap-2 mb-1">
                  <BsClock />
                  «·›«’· «·“„‰Ì »Ì‰ «·—”«∆·: <span className="text-[#8B6CF6]">{interval} ÀÊ«‰Ú</span>
                </label>
                <input
                  type="range"
                  min={3}
              ...
              {isSending && (
                <div className="bg-[#6A47ED]/10 border border-[#6A47ED]/20 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#A78BFA] text-sm">Ã«—Ì «·≈—”«·...</span>
              ...
              >
                <BsSend />
                {isSending ? 'Ã«—Ì «·≈—”«·...' : `≈—”«· ·‹ ${csvData.length} ‘Œ’`}
              </button>
            </div>
          </div>
        )}
        ...
        {sendMode === 'share' && (
          <div className="glass rounded-3xl p-8 md:p-12 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                <h3 className="text-xl font-black text-white">„‘«—ﬂ… ”—Ì⁄…</h3>
                <p className="text-gray-400 text-sm">‘«—ﬂ  Â‰∆ ﬂ ⁄»— √Ì „‰’… »÷€ÿ… Ê«Õœ…</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-white text-sm font-bold">{copied ? ' „ «·‰”Œ!' : '‰”Œ —«»ÿ «·„Õ——'}</p>
                  <p className="text-gray-400 text-xs">‘«—ﬂ —«»ÿ «·„‰’… „⁄ √’œﬁ«∆ﬂ</p>
                </div>
              </button>
              ...
              <button
                onClick={() => {
                  const text = encodeURIComponent(`${message}\n\n’„¯„ »ÿ«ﬁ ﬂ „‰ Â‰«: ${window.location.origin}/editor`)
                  window.open(`https://wa.me/?text=${text}`, '_blank')
                }}
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-white text-sm font-bold">Ê« ”«»</p>
                  <p className="text-gray-400 text-xs">‘«—ﬂ «· Â‰∆… ›Ì Ê« ”«»</p>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-white text-sm font-bold"> ·ÌÃ—«„</p>
                  <p className="text-gray-400 text-xs">‘«—ﬂ «· Â‰∆… ›Ì  ·ÌÃ—«„</p>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-white text-sm font-bold"> ÊÌ — / X</p>
                  <p className="text-gray-400 text-xs">€—¯œ » Â‰∆ ﬂ</p>
                </div>
              </button>
              ...
              <button
                onClick={() => {
                  const subject = encodeURIComponent(' Â‰∆… ⁄Ìœ „»«—ﬂ')
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-white text-sm font-bold">»—Ìœ ≈·ﬂ —Ê‰Ì</p>
                  <p className="text-gray-400 text-xs">√—”· »«·»—Ìœ «·≈·ﬂ —Ê‰Ì</p>
                </div>
              </button>
            </div>
            ...
            <div className="mt-6 pt-5 border-t border-white/5">
              <label className="text-sm text-gray-400 block mb-2"> Œ’Ì’ ‰’ «·„‘«—ﬂ…</label>
              <textarea
                value={message}
                onChange={(e) => setMessage(e.target.value)}
                className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-white text-sm resize-none focus:border-[#6A47ED]/50 focus:outline-none"
        ...
        {sendMode === 'zip' && (
          <div className="glass rounded-3xl p-8 md:p-12 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                <h3 className="text-xl font-black text-white"> Õ„Ì· ZIP</h3>
                <p className="text-gray-400 text-sm">Õ„¯· Ã„Ì⁄ «·»ÿ«ﬁ«  «·„Œ’’… ›Ì „·› Ê«Õœ</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-6 text-center">
                ...
                <h4 className="text-white font-bold mb-2"> Ê·Ìœ »ÿ«ﬁ«  „Œ’’…</h4>
                <p className="text-gray-400 text-sm mb-4">
                  «—›⁄ „·› CSV »«·√”„«¡ Ê”Ì „  Ê·Ìœ »ÿ«ﬁ… „Œ’’… ·ﬂ· ‘Œ’ Ê Õ„Ì·Â« ›Ì „·› ZIP
                </p>
                <p className="text-purple-300 text-xs">
                  Â–Â «·„Ì“…  Õ «Ã «‘ —«ﬂ <span className="font-bold">«·‘—ﬂ« </span> √Ê <span className="font-bold">«·„Ê“⁄</span>
                </p>
              </div>
              ...
              {csvData.length > 0 && (
                <p className="text-green-400 text-sm text-center">? {csvData.length} «”„ Ã«Â“ ·· Ê·Ìœ</p>
              )}
        ...
        <div className="text-center mt-10">
          <p className="text-gray-500 text-sm mb-3">·„  ’„„ »ÿ«ﬁ ﬂ »⁄œø</p>
          <Link
            to="/editor"
