...
export default function SendPage() {
  ...
  const handleGenerateEidiya = () => {
    ...
    if (eidiyaMin >= eidiyaMax) {
      toast.error('الحد الأقصى لازم يكون أكبر من الأدنى')
      return
    }
    const params = new URLSearchParams({
  ...
  const handleBulkSend = async () => {
    if (csvData.length === 0) {
      toast.error('قم برفع ملف CSV أولاً')
      return
    }
    setIsSending(true)
    setSentCount(0)
    ...
    for (let i = 0; i < csvData.length; i++) {
      ...
      const phoneNum = row['الرقم'] || row['phone'] || row['رقم'] || ''
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mb-10">
          {[
            ...
            { id: 'zip', icon: <BsFileZip />, label: 'تحميل ZIP', desc: 'بطاقات مخصصة' },
          ].map((mode) => (
            <button
              key={mode.id}
          ...
          <div className="glass rounded-3xl p-8 md:p-10 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">أنشئ رابط عيدية — المستلم يلف العداد ويشوف حظه</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <option value="om" className="bg-gray-900">عُماني</option>
                  </select>
                  <select
                  ...
                  >
                    ...
                    <option value="دينار بحريني" className="bg-gray-900">دينار بحريني</option>
                    <option value="ريال قطري" className="bg-gray-900">ريال قطري</option>
                    <option value="ريال عُماني" className="bg-gray-900">ريال عُماني</option>
                  </select>
                </div>
              </div>
          ...
          <div className="glass rounded-3xl p-8 md:p-10 max-w-2xl mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">اختر بطاقة، اكتب الاسم، وشارك الرابط — يفتحها المستلم مباشرة</p>
              </div>
            </div>
                ...
                <div className="space-y-4 pt-4 border-t border-white/5 animate-fadeInUp">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                      ...
                      <span className="text-blue-300 text-xs font-bold">تليجرام</span>
                    </button>
                    <button
                      onClick={() => {
                        const text = encodeURIComponent(`${linkGreeting} يا ${linkName}\n\n`)
          ...
          <div className="glass rounded-3xl p-8 md:p-10 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">أرسل بطاقة فاخرة لشخص واحد عبر واتساب</p>
              </div>
            </div>
        ...
        {sendMode === 'share' && (
          <div className="glass rounded-3xl p-8 md:p-10 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => {
                  const text = encodeURIComponent(`${message}\n\nصمّم بطاقتك من هنا: ${window.location.origin}/editor`)
                  window.open(`https://wa.me/?text=${text}`, '_blank')
                }}
              ...
              <button
                onClick={() => {
                  const subject = encodeURIComponent('تهنئة عيد مبارك')
                  const body = encodeURIComponent(`${message}\n\nصمّم بطاقتك الخاصة من:\n${window.location.origin}/editor`)
            ...
            <div className="mt-6 pt-5 border-t border-white/5">
              <label className="text-sm text-gray-400 block mb-2">تخصيص نص المشاركة</label>
              <textarea
                value={message}
                onChange={(e) => setMessage(e.target.value)}
                className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-white text-sm resize-none focus:border-[#6A47ED]/50 focus:outline-none"
          ...
          <div className="glass rounded-3xl p-8 md:p-10 max-w-lg mx-auto border border-white/5 hover:border-[#6A47ED]/10 transition-all">
            ...
            <div className="space-y-4">
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-6 text-center">
                ...
                <h4 className="text-white font-bold mb-2">توليد بطاقات مخصصة</h4>
                <p className="text-gray-400 text-sm mb-4">
                  ارفع ملف CSV بالأسماء وسيتم توليد بطاقة مخصصة لكل شخص وتحميلها في ملف ZIP
                </p>
                <p className="text-purple-300 text-xs">
                  هذه الميزة تحتاج اشتراك <span className="font-bold">الشركات</span> أو <span className="font-bold">الموزع</span>
                </p>
              </div>
              ...
              >
                ...
                <p className="text-gray-400 text-sm">رفع ملف CSV</p>
              </div>

              {csvData.length > 0 && (
                <p className="text-green-400 text-sm text-center">✓ {csvData.length} اسم جاهز للتوليد</p>
              )}
