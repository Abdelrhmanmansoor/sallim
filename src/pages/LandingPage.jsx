...
export default function LandingPage() {
  ...
  return (
    <div dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
      ...
      {/* CORPORATE PACKAGES */}
      <section id="corporate-packages" style={{ padding: '100px 0', background: 'linear-gradient(180deg, #0f172a 0%, #1e293b 100%)', position: 'relative', overflow: 'hidden' }}>
        {/* Decorative elements */}
        <div style={{ position: 'absolute', top: '-60px', right: '-60px', width: '200px', height: '200px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(168,85,247,0.15), transparent)', filter: 'blur(40px)' }} />
        <div style={{ position: 'absolute', bottom: '-40px', left: '-40px', width: '180px', height: '180px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(212,175,55,0.12), transparent)', filter: 'blur(40px)' }} />

        <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            <span style={{ display: 'inline-block', background: 'rgba(168,85,247,0.15)', color: '#c084fc', padding: '6px 20px', borderRadius: '100px', fontSize: '13px', fontWeight: 700, border: '1px solid rgba(168,85,247,0.25)', marginBottom: '20px' }}>
              نظام تهاني الشركات
            </span>
            <h2 style={{ fontSize: 'clamp(28px, 4.5vw, 44px)', fontWeight: 900, color: '#fff', lineHeight: 1.3, marginBottom: '16px' }}>
              باقات التهاني لكل المواسم
            </h2>
            <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.5)', maxWidth: '600px', margin: '0 auto', lineHeight: 1.8 }}>
              نظام متكامل لإرسال تهاني الأعياد والمناسبات — عيد الفطر، الأضحى، اليوم الوطني، أعياد الميلاد، وأكثر
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(270px, 1fr))', gap: '20px', alignItems: 'stretch' }}>

            {/* PACKAGE 1 — Starter 79 SAR one-time */}
            <div style={{
            ...
            >
              <span style={{ fontSize: '13px', color: '#94a3b8', fontWeight: 600, letterSpacing: '0.05em' }}>للأفراد والمؤسسات الصغيرة</span>
              <h3 style={{ fontSize: '22px', fontWeight: 800, color: '#fff', marginTop: '8px', marginBottom: '16px' }}>باقة البداية</h3>
              <div style={{ marginBottom: '24px' }}>
                <span style={{ fontSize: '48px', fontWeight: 900, color: '#d4af37' }}>79</span>
                <span style={{ fontSize: '18px', color: '#94a3b8', marginRight: '4px' }}> ر.س</span>
                <span style={{ fontSize: '13px', color: '#64748b', display: 'block', marginTop: '4px' }}>لمرة واحدة فقط</span>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, flex: 1, display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {[
                  'حتى 20 اسم في المرة الواحدة',
                  'قوالب أنيقة جاهزة',
                  'تخصيص النص واللون',
                  'مشاركة عبر رابط أو واتساب',
                  'تنزيل البطاقات كصور',
                  'دعم المناسبات الرسمية',
                ].map((f, i) => (
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: '14px', color: 'rgba(255,255,255,0.7)' }}>
                    <span style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(212,175,55,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', flexShrink: 0 }}>✓</span>
                    {f}
                  </li>
                ))}
              </ul>
              <Link
                to="/editor?mode=batch"
                style={{ marginTop: '28px', display: 'block', textAlign: 'center', padding: '14px', background: 'rgba(212,175,55,0.12)', color: '#d4af37', fontSize: '15px', fontWeight: 700, borderRadius: '14px', textDecoration: 'none', border: '1px solid rgba(212,175,55,0.25)', transition: 'all 200ms' }}
            ...
            {/* PACKAGE 2 — Business 199 SAR/year */}
            <div style={{
              background: 'linear-gradient(160deg, rgba(168,85,247,0.12), rgba(99,102,241,0.08))',
              backdropFilter: 'blur(10px)',
              ...
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-6px)'; e.currentTarget.style.boxShadow = '0 8px 50px rgba(168,85,247,0.2)' }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 0 40px rgba(168,85,247,0.1)' }}
            >
              <span style={{ position: 'absolute', top: '-14px', left: '50%', transform: 'translateX(-50%)', background: 'linear-gradient(135deg, #a855f7, #7e22ce)', color: '#fff', padding: '6px 20px', borderRadius: '100px', fontSize: '12px', fontWeight: 800 }}>
                الأكثر طلباً
              </span>
              <span style={{ fontSize: '13px', color: '#c084fc', fontWeight: 600, letterSpacing: '0.05em' }}>للشركات المتوسطة</span>
              <h3 style={{ fontSize: '22px', fontWeight: 800, color: '#fff', marginTop: '8px', marginBottom: '16px' }}>باقة الأعمال</h3>
              <div style={{ marginBottom: '24px' }}>
                <span style={{ fontSize: '48px', fontWeight: 900, color: '#c084fc' }}>199</span>
                <span style={{ fontSize: '18px', color: '#94a3b8', marginRight: '4px' }}> ر.س</span>
                <span style={{ fontSize: '13px', color: '#64748b', display: 'block', marginTop: '4px' }}>سنوياً / استخدام متكرر</span>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, flex: 1, display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {[
                  'حتى 500 رسالة في السنة',
                  'جميع المواسم والمناسبات الرسمية',
                  'رفع شعار الشركة على البطاقات',
                  'قوالب حصرية للشركات',
                  'جدولة الإرسال التلقائي',
                  'تقارير وإحصائيات الإرسال',
                  'دعم فني أولوية عبر واتساب',
                ].map((f, i) => (
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: '14px', color: 'rgba(255,255,255,0.7)' }}>
                    <span style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(168,85,247,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', color: '#c084fc', flexShrink: 0 }}>✓</span>
                    {f}
                  </li>
                ))}
              </ul>
              <Link
                to="/editor?mode=batch"
                style={{ marginTop: '28px', display: 'block', textAlign: 'center', padding: '14px', background: 'linear-gradient(135deg, #a855f7, #7e22ce)', color: '#fff', fontSize: '15px', fontWeight: 700, borderRadius: '14px', textDecoration: 'none', transition: 'all 200ms', boxShadow: '0 4px 20px rgba(168,85,247,0.3)' }}
            ...
            {/* PACKAGE 3 — Enterprise 1499 SAR/year */}
            <div style={{
              background: 'linear-gradient(160deg, rgba(212,175,55,0.08), rgba(245,215,122,0.04))',
              backdropFilter: 'blur(10px)',
              ...
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.borderColor = 'rgba(212,175,55,0.2)' }}
            >
              <span style={{ position: 'absolute', top: '-14px', left: '50%', transform: 'translateX(-50%)', background: 'linear-gradient(135deg, #d4af37, #b8860b)', color: '#fff', padding: '6px 20px', borderRadius: '100px', fontSize: '12px', fontWeight: 800 }}>
                المؤسسي
              </span>
              <span style={{ fontSize: '13px', color: '#d4af37', fontWeight: 600, letterSpacing: '0.05em' }}>للشركات الكبرى والجهات الحكومية</span>
              <h3 style={{ fontSize: '22px', fontWeight: 800, color: '#fff', marginTop: '8px', marginBottom: '16px' }}>الباقة المؤسسية</h3>
              <div style={{ marginBottom: '24px' }}>
                <span style={{ fontSize: '48px', fontWeight: 900, color: '#d4af37' }}>1,499</span>
                <span style={{ fontSize: '18px', color: '#94a3b8', marginRight: '4px' }}> ر.س</span>
                <span style={{ fontSize: '13px', color: '#64748b', display: 'block', marginTop: '4px' }}>سنوياً / شامل كل شيء</span>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, flex: 1, display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {[
                  'حتى 10,000 رسالة في السنة',
                  'كل المواسم + أعياد ميلاد الموظفين',
                  'تهاني المناسبات الشخصية (ترقية، زواج...)',
                  'رفع شعار وهوية الشركة كاملة',
                  'قوالب مخصصة حسب الطلب',
                  'ربط مع نظام HR (تذكير تلقائي)',
                  'جدولة ذكية + إرسال تلقائي بالاسم',
                  'تقارير مفصّلة + لوحة تحكم إدارية',
                  'مدير حساب مخصص + دعم VIP',
                ].map((f, i) => (
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: '14px', color: 'rgba(255,255,255,0.7)' }}>
                    <span style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(212,175,55,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', color: '#d4af37', flexShrink: 0 }}>✓</span>
                    {f}
                  </li>
                ))}
              </ul>
              <a
                ...
                style={{ marginTop: '28px', display: 'block', textAlign: 'center', padding: '14px', background: 'linear-gradient(135deg, #d4af37, #b8860b)', color: '#fff', fontSize: '15px', fontWeight: 700, borderRadius: '14px', textDecoration: 'none', transition: 'all 200ms', boxShadow: '0 4px 20px rgba(212,175,55,0.3)' }}
                onMouseEnter={(e) => { e.currentTarget.style.transform = 'scale(1.02)' }}
                onMouseLeave={(e) => { e.currentTarget.style.transform = 'scale(1)' }}
              >
            ...
            {/* PACKAGE 4 — Custom 2500 SAR */}
            <div style={{
              background: 'linear-gradient(160deg, rgba(99,102,241,0.08), rgba(168,85,247,0.05))',
              backdropFilter: 'blur(10px)',
            ...
            >
              <span style={{ position: 'absolute', top: '-14px', left: '50%', transform: 'translateX(-50%)', background: 'linear-gradient(135deg, #6366f1, #4338ca)', color: '#fff', padding: '6px 20px', borderRadius: '100px', fontSize: '12px', fontWeight: 800 }}>
                باقة خاصة
              </span>
              <span style={{ fontSize: '13px', color: '#818cf8', fontWeight: 600, letterSpacing: '0.05em' }}>تصميم وتطوير حسب الطلب</span>
              <h3 style={{ fontSize: '22px', fontWeight: 800, color: '#fff', marginTop: '8px', marginBottom: '16px' }}>الباقة الخاصة</h3>
              <div style={{ marginBottom: '24px' }}>
                <span style={{ fontSize: '48px', fontWeight: 900, color: '#818cf8' }}>2,500</span>
                <span style={{ fontSize: '18px', color: '#94a3b8', marginRight: '4px' }}> ر.س</span>
                <span style={{ fontSize: '13px', color: '#64748b', display: 'block', marginTop: '4px' }}>رابط خاص + نظام مخصص بالكامل</span>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, flex: 1, display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {[
                  ...
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: '14px', color: 'rgba(255,255,255,0.7)' }}>
                    <span style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(99,102,241,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', color: '#818cf8', flexShrink: 0 }}>✓</span>
                    {f}
                  </li>
                ))}
              </ul>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ marginTop: '28px', display: 'block', textAlign: 'center', padding: '14px', background: 'linear-gradient(135deg, #6366f1, #4338ca)', color: '#fff', fontSize: '15px', fontWeight: 700, borderRadius: '14px', textDecoration: 'none', transition: 'all 200ms', boxShadow: '0 4px 20px rgba(99,102,241,0.3)' }}
                onMouseEnter={(e) => { e.currentTarget.style.transform = 'scale(1.02)' }}
                onMouseLeave={(e) => { e.currentTarget.style.transform = 'scale(1)' }}
              >
                تواصل معنا عبر واتساب
          ...
          {/* Trust badges */}
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '32px', marginTop: '56px', opacity: 0.5 }}>
            {['دفع آمن', 'يعمل على كل الأجهزة', 'إعداد فوري', 'دعم عربي متواصل'].map((b, i) => (
              <span key={i} style={{ fontSize: '13px', color: 'rgba(255,255,255,0.6)', fontWeight: 600 }}>{b}</span>
            ))}
          </div>
        </div>
      </section>
